function fillTagService(tagService) {
	...
	tagService.registerTag(new Tag("place:java-ee", "Java EE \/ Jakarta EE", false, true, null), ['techreport:placerows','techrow:java-ee',]);
	...
	tagService.registerTag(new Tag("techrow:java-ee", "Java EE \/ Jakarta EE", false, true, null), ['techreport-rows:',]);
	...
	tagService.registerTag(new Tag("techbox:persistence", "Persistence", false, true, null), ['techrow:java-ee','techrow:embedded','techsector03:store',]);
	...
	tagService.registerTag(new Tag("java-ee", "Java EE \/ Jakarta EE", true, false, "#00CC00"), []);
